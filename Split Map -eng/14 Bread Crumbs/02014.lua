...
elevator_sound_polys = {
	349, 350, 351, 352, 380,
	24, 26, 19, 22, 25, 381,
	456, 454, 330, 63, 348, 347 };
dir = '';
...
function level_idle()
	...
	if (not elevator_active) and power_light.active then
	...
	if elevator_active then
		Players[0].overlays[0].text = "Floor: "..floor
		Players[0].overlays[0].color = "cyan";
		Players[0].overlays[1].text = "Going: "..dir

		if dir == 'UP' then
			Players[0].overlays[1].color = "dark green";
		else
			Players[0].overlays[1].color = "dark red";
		end
	end
end
